...
global.mods = ['6285832079751@s.whatsapp.net']
global.prems = ['6285832079751@s.whatsapp.net']

global.dfail = (type, m, conn) => {
  let msg = {
    owner: 'Perintah ini hanya dapat digunakan oleh Owner sad',
    mods: 'Perintah ini hanya dapat digunakan oleh Moderator sad!',
    premium: 'Perintah ini hanya untuk member Premium sad!',
